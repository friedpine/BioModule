...
def Group_Samples_VCF_from_Bam_rmd(cursor,conn,samples,group_name,file_type,SNV_type,SNV_process_type,outdir,cmd_file):
	...
	w2 = m00.COMMAND_generator(cursor,conn,[group_name],"/data/Analysis/fanxiaoying/software/samtools-0.1.19/bcftools/bcftools view #0 | perl /data/Analysis/fanxiaoying/project/project01_polyA-RNAseq/modules/scripts/vcfutils.pl varFilter -d 5 >#1",['SNV'],outdir,'.vcf',SNV_process_type)
